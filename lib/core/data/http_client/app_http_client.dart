...
class AppHttpClient extends BaseClient {
  ...
  AppHttpClient({required this.client, this.mapper}) : super(client: client, mapper: mapper);

  @override
  AppHttpClient copyWith(ResponseExceptionMapper? mapper) => AppHttpClient(client: client, mapper: mapper);
