...
class ServerFieldErrors with _$ServerFieldErrors {
  ...
  const factory ServerFieldErrors({
    ...
    @JsonKey(includeIfNull: false) List<String?>? username,
    ...
    @JsonKey(includeIfNull: false) List<String?>? value,
    @JsonKey(includeIfNull: false, name: 'current_password') List<String?>? oldPassword,
    ...
    @JsonKey(includeIfNull: false, name: 'currency_id') List<String?>? currencyId,
    @JsonKey(includeIfNull: false) List<String?>? country,
    @JsonKey(includeIfNull: false) List<String?>? comment,
    @JsonKey(includeIfNull: false, name: 'account_number') List<String?>? accountNumber,
    ...
    @JsonKey(includeIfNull: false, name: 'payment_method') List<String?>? paymentMethod,
    //
    @JsonKey(includeIfNull: false, name: 'pickup_lat') List<String?>? pickupLat,
    @JsonKey(includeIfNull: false, name: 'destination_lat') List<String?>? destLat,
    ...
    @JsonKey(includeIfNull: false, name: 'card_number') List<String?>? cardNumber,
    ...
    @JsonKey(includeIfNull: false, name: 'required_date') List<String?>? requiredDate,
    @JsonKey(includeIfNull: false, name: 'message') List<String?>? supportMessage,
    //
    @JsonKey(includeIfNull: false) List<String?>? topics,
    @JsonKey(includeIfNull: false) List<String?>? body,
  }) = _ServerFieldErrors;
