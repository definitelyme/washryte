...
class _$_ServerFieldErrors extends _ServerFieldErrors {
  const _$_ServerFieldErrors(
      ...
      @JsonKey(includeIfNull: false) this.topics,
  ...
  @override
  String toString() {
    return 'ServerFieldErrors(name: $name, firstName: $firstName, lastName: $lastName, token: $token, email: $email, username: $username, gender: $gender, age: $age, phone: $phone, password: $password, value: $value, oldPassword: $oldPassword, code: $code, type: $type, description: $description, document: $document, duration: $duration, amount: $amount, currencyId: $currencyId, country: $country, comment: $comment, accountNumber: $accountNumber, bankId: $bankId, recipient: $recipient, plan: $plan, paymentMethod: $paymentMethod, pickupLat: $pickupLat, destLat: $destLat, lat: $lat, long: $long, zip: $zip, instructions: $instructions, countryId: $countryId, alias: $alias, apartment: $apartment, street: $street, town: $town, city: $city, stateId: $stateId, state: $state, landmark: $landmark, cardNumber: $cardNumber, cardName: $cardName, itemName: $itemName, quantity: $quantity, unitPrice: $unitPrice, images: $images, requiredDate: $requiredDate, supportMessage: $supportMessage, topics: $topics, body: $body)';
  }
...
abstract class _ServerFieldErrors extends ServerFieldErrors {
  const factory _ServerFieldErrors(
      ...
      @JsonKey(includeIfNull: false)
          List<String?>? topics,
      @JsonKey(includeIfNull: false)
          List<String?>? body}) = _$_ServerFieldErrors;
