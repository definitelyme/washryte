mixin WebSocketEvent {
  ...
  static String get riderReceivedPackageEvent => '.package.user.received';
  static String riderReceivedPackageChannel(String id) =>
      'package.user.received.$id';

  // Rider has delivered package to receiver Event & Channel
  static String get riderDeliveredPackageEvent => '.package.user.delivered';
  static String riderDeliveredPackageChannel(String id) =>
      'package.user.delivered.$id';
}
