...
class AddressComponentDTO with _$AddressComponentDTO {
  ...
  const factory AddressComponentDTO({
    ...
    @AddressComponentTypeSerializer() @Default([]) List<AddressComponentType> types,
...
class AddressComponentTypeSerializer implements JsonConverter<AddressComponentType, String?> {
  const AddressComponentTypeSerializer();

  @override
  AddressComponentType fromJson(String? value) => AddressComponentType.valueOf(value ?? '');
