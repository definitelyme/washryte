...
class PlaceDetailDTO with _$PlaceDetailDTO {
  const factory PlaceDetailDTO({
    @JsonKey(name: 'address_components') @Default([]) List<AddressComponentDTO> addressComponents,
  ...
  factory PlaceDetailDTO.fromJson(Map<String, dynamic> json) => _$PlaceDetailDTOFromJson(json);
  ...
  KtList<PlaceDetail?> get geocodes => KtList.from(geocodingResults?.map((e) => e.domain) ?? []);
}
