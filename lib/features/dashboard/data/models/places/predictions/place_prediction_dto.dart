...
class PlacePredictionDTO with _$PlacePredictionDTO {
  ...
  const factory PlacePredictionDTO({
    ...
    String? description,
    List<String>? types,
    @Default([]) @JsonKey(name: 'matched_substrings') List<MatchedStringsDTO?> matchedSubstrings,
    //
  ...
  factory PlacePredictionDTO.fromJson(Map<String, dynamic> json) => _$PlacePredictionDTOFromJson(json);
  ...
  KtList<PlacePrediction?> get immutable => KtList.from(predictions.map((e) => e?.domain));
}
...
class MatchedStringsDTO with _$MatchedStringsDTO {
  ...
  /// Maps the incoming Json to a Data Transfer Object (DTO).
  factory MatchedStringsDTO.fromJson(Map<String, dynamic> json) => _$MatchedStringsDTOFromJson(json);
