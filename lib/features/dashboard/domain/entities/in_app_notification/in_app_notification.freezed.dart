...
mixin _$InAppNotification {
  ...
  BasicTextField<String?> get message => throw _privateConstructorUsedError;
...
class _$_InAppNotification extends _InAppNotification {
  ...
  @override
  final BasicTextField<String?> message;
  @override
  ...
  @override
  String toString() {
    return 'InAppNotification(id: $id, title: $title, message: $message, meta: $meta, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
  }
...
abstract class _InAppNotification extends InAppNotification {
  ...
  @override
  BasicTextField<String?> get message;
  @override
